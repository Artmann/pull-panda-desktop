export const ipcChannels = {
  ...
  RepoCheckoutCheckout: 'repo-checkout:checkout',
  RepoCheckoutClone: 'repo-checkout:clone',
  RepoCheckoutPickFolder: 'repo-checkout:pick-folder',
  RepoCheckoutRemove: 'repo-checkout:remove',
  RepoCheckoutSet: 'repo-checkout:set',
  RepoCheckoutVerify: 'repo-checkout:verify',
