...
const pullPandaPaperPalette: ThemePalette = {
  ...
  muted: 'oklch(0.945 0.009 95)',
  mutedForeground: 'oklch(0.45 0.008 95)',
  popover: 'oklch(1 0 0)',
  popoverForeground: 'oklch(0.22 0.01 95)',
  primary: 'oklch(0.52 0.19 262)',
  primaryForeground: 'oklch(0.985 0.003 95)',
  ring: 'oklch(0.52 0.19 262)',
  secondary: 'oklch(0.955 0.005 95)',
  secondaryForeground: 'oklch(0.22 0.01 95)',
  sidebar: 'oklch(0.955 0.006 95)',
  sidebarAccent: 'oklch(0.9 0.009 95)',
  sidebarAccentForeground: 'oklch(0.32 0.012 95)',
  sidebarBorder: 'oklch(0.88 0.008 95)',
  sidebarForeground: 'oklch(0.36 0.012 95)',
  sidebarPrimary: 'oklch(0.52 0.19 262)',
  sidebarPrimaryForeground: 'oklch(0.985 0.003 95)',
  sidebarRing: 'oklch(0.52 0.19 262)',
  statusDanger: 'oklch(0.95 0.035 25)',
  statusDangerBorder: 'oklch(0.86 0.08 25)',
  statusDangerForeground: 'oklch(0.4 0.14 25)',
...
const pullPandaMidnightPalette: ThemePalette = {
  ...
  accentForeground: 'oklch(0.92 0.006 240)',
  background: 'oklch(0.19 0.009 240)',
  border: 'oklch(0.36 0.012 240)',
  card: 'oklch(0.245 0.009 240)',
  cardForeground: 'oklch(0.92 0.006 240)',
  chart1: 'oklch(0.72 0.14 10)',
  chart2: 'oklch(0.75 0.14 55)',
  chart3: 'oklch(0.85 0.12 95)',
  chart4: 'oklch(0.7 0.16 155)',
  ...
  destructiveForeground: 'oklch(0.19 0.009 240)',
  foreground: 'oklch(0.92 0.006 240)',
  input: 'oklch(0.36 0.012 240)',
  muted: 'oklch(0.275 0.009 240)',
  mutedForeground: 'oklch(0.665 0.012 240)',
  popover: 'oklch(0.245 0.009 240)',
  popoverForeground: 'oklch(0.92 0.006 240)',
  primary: 'oklch(0.56 0.21 262)',
  primaryForeground: 'oklch(0.985 0.004 240)',
  ring: 'oklch(0.7 0.15 262)',
  secondary: 'oklch(0.275 0.009 240)',
  secondaryForeground: 'oklch(0.92 0.006 240)',
  sidebar: 'oklch(0.15 0.009 240)',
  sidebarAccent: 'oklch(0.3 0.01 240)',
  sidebarAccentForeground: 'oklch(0.92 0.006 240)',
  sidebarBorder: 'oklch(0.36 0.012 240)',
  sidebarForeground: 'oklch(0.86 0.008 240)',
  sidebarPrimary: 'oklch(0.56 0.21 262)',
  sidebarPrimaryForeground: 'oklch(0.985 0.004 240)',
  sidebarRing: 'oklch(0.7 0.15 262)',
  statusDanger: 'oklch(0.3 0.035 25)',
  statusDangerBorder: 'oklch(0.42 0.06 25)',
  statusDangerForeground: 'oklch(0.82 0.08 25)',
  statusMerged: 'oklch(0.3 0.035 300)',
  statusMergedBorder: 'oklch(0.42 0.06 300)',
  statusMergedForeground: 'oklch(0.82 0.08 300)',
  statusNeutral: 'oklch(0.3 0.006 270)',
  statusNeutralBorder: 'oklch(0.42 0.012 270)',
  statusNeutralForeground: 'oklch(0.82 0.02 270)',
  statusSuccess: 'oklch(0.3 0.035 150)',
  statusSuccessBorder: 'oklch(0.42 0.05 150)',
  statusSuccessForeground: 'oklch(0.82 0.08 150)',
  statusWarning: 'oklch(0.3 0.035 80)',
  statusWarningBorder: 'oklch(0.42 0.06 80)',
  statusWarningForeground: 'oklch(0.82 0.08 80)',
  titlebar: 'oklch(0.14 0.009 240)'
}
